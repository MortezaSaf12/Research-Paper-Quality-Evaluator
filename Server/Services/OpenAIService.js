...
class OpenAIService {
  ...
  async evaluatePaper(file) {
    try {
      // Extract text content from xthe file
...
- **Value**: The specific result or outcome that was discovered.  Explain a bit also of the result/outcome so we don't keep it too general about it.
- **Evidence Level**: Assign an evidence level (1-6) based on the guidelines and justify this classification by explanining how you evaluated and made the result that this is the evidence level
- **Source**: The title of the paper where this finding is from as well as the publishing year and author.
- **Methodology Quality**: Explain how the metholodgy was determined based on the guidelines.txt how the finding was determined.  
- **Importance**: Why this finding matters in the context of the research field

Format Example (Do n):
Key Finding #1
- Criteria: [Subject of finding]
- Value: [Specific result/outcome. Explain a bit also of the result/outcome]
- Evidence Level: [1-6] 
- Source: [Paper title, include year of the paper too as well as the author]
- Methodology Quality: [Explain your reasoning behind why this keyfinding got this certain evaluation of the evidence level]
